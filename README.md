...
Exécutez le programme d’installation :
 sudo ./aws/install
Par défaut, aws cli est installé dans /usr/local/aws-cli* ainsi qu'un lien symbolique dans */usr/local/bin.
Pour vérifier que l’installation a fonctionné :
 aws --version

# Crééer une paire cle acces et secret clé d'acces
aller dans la console aws useriam
aller dans son compte securité et creer la paire de clé

#configurer aws cli
 aws configure
Entrez les détails suivants en fonction de vos informations :
